...
(function($) {
    'use strict';
     ...
     var loading_text = "Memuat..."; // text for preloader. If you don't use text just leave it blank
     var preloader_custom_image = '/assets/images/logo.jpg'; // insert image url to enable custom image, off - for disable custom image

    // var preloader_custom_image = 'off';
    //  var loading_text_position = "0px"; // set position for loading text. Default value is 0px
     ...
     function de_loader(){
        if(preloader_custom_image=="off"){
            ...
            // .append( $("<div/>").addClass("text").text(loading_text))
            // )
            var myHtml = '<div class="custom-loader-image">'+
                            '<img class="wow pulse" data-wow-iteration="99" src="'+ preloader_custom_image +'" style="max-width: 100%">'+
                            '<div class="text wow fadeIn" data-wow-duration="1.5s" data-wow-iteration="99" style="margin-top: 2rem; position: relative; z-index: 1;">Memuat...</div>'+
                        '</div>';
        }
        $("#de-preloader").append(myHtml);
        // $('.custom-loader-image').prepend('<img src="'+preloader_custom_image+'" style="max-width: 100%" />');
